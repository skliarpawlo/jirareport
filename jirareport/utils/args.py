...
report_parser.add_argument(u'--format', metavar=u'format', help=u'text | html', required=False)
...
report_parser.set_defaults(func=report, y=for_date.year, m=for_date.month, format=u'text')
